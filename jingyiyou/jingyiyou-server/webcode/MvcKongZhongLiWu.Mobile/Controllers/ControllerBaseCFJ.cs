...
{
    public class ControllerBaseVIP : Controller
    {
        protected ncc2019Entities db = new ncc2019Entities();
        
        public ncc2019.Common.Model.MemberInfo CurMemberInfo { get { return ncc2019.Common.Tool.SessionHelper.CurMemberInfo; } }
        public ControllerBaseVIP()
        {
            ...
            #region 全景统计参数生成
            //ViewBag.cnzz = new CS(1261867401).TrackPageView();
            #endregion
        ...
        protected virtual bool CheckUser()
        {
            ...
            if (SessionHelper.CurMemberInfo == null)
            {
                if (!string.IsNullOrEmpty(System.Web.HttpContext.Current.Request.QueryString["uid"]))
                {
                    ...
                    ncc2019.Common.Tool.SessionHelper.CurMemberInfo = Common.Model.MemberInfo.BuildMemberInfo(memberModel);
    ...
    public class ControllerBaseVIPNoCheck : Controller
    {
       
        protected ncc2019Entities db = new ncc2019Entities();
        public Common.Model.MemberInfo CurMemberInfo { get { return ncc2019.Common.Tool.SessionHelper.CurMemberInfo; } }
        public ControllerBaseVIPNoCheck()
        {
